...
{
    public partial class FrmListadoSociosDeudoderes : Form
    {
        public FrmListadoSociosDeudoderes()
        {
            InitializeComponent();
        }

        clsSocio ObjSocio = new clsSocio();
        private void FrmListadoSociosDeudoderes_Load(object sender, EventArgs e)
        {
        ...
        {
            ObjSocio.ListarDeudores(dgvSocios);
